...
class Attention(nn.Module):
    def __init__(self, hidden_size):
        ...
        self.attention_network = nn.Sequential(nn.Linear(self.hidden_size*2,self.hidden_size),
...
class AttentionDecoder(nn.Module):
    ...
    def forward(self, x, h_prev, annotations):
        ...
        # context = ...
        context = torch.bmm(attention_weights.transpose(1,2),annotations).squeeze(1)
        # embed_and_context = ...
